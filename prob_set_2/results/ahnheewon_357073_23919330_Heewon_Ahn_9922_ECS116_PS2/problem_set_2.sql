...
from m49_codes_expanded mc
where region_name = 'Africa'  and intermediate_region_code is NULL
...
from africa_fs_ac a, m49_codes_expanded m 
where m.m49_code = a.area_code_m49 
 and item_code = '22013' and "year_code" in ('2011','2012','2013','2014','2015','2016','2017','2018','2019','2020')
group by  m.intermediate_region_code,
         m.intermediate_region_name
...
select
    ...
    max(value) as max_gdp,
    min (value) as  min_gdp
from   africa_fs_ac a join m49_codes_expanded m on m.m49_code = a.area_code_m49 
where  item_code = '22013' 
group by
    m.intermediate_region_code,
    m.intermediate_region_name
