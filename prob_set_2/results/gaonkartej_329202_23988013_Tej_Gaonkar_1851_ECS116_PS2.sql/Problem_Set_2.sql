...
from m49_codes_expanded 
where region_name = 'Africa'
  and intermediate_region_code isnull and country_or_area != sub_region_name 
order by country_or_area;
...
select m.sub_region_code,
       m.sub_region_name,
       ROUND(AVG(a.value)::numeric, 0) AS avg_gdp_per_capita
from africa_fs_ac a
join m49_codes_expanded m ON m.m49_code = a.area_code_m49 
where item_code = '22013'
  and m.sub_region_code IS NOT NULL
