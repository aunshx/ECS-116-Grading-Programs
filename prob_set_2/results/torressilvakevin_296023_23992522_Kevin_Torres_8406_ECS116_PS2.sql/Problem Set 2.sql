...
where ir.m49_code = a.area_code_m49
and sr.m49_code = a.area_code_m49;
-- Interestingly, most mot not all countries from Africa have an intermediate
region
...
-- more readable
-- e.g., see https://stackoverflow.com/questions/13113096/how-to-round-an-average-
to-2-decimal-places-in-postgresql
...
from africa_fs_ac ac join m49_codes_expanded mce  on ac.area_code_m49  = mce.m49_code 
...
from africa_fs_ac ac join m49_codes_expanded mce  on ac.area_code_m49  = mce.m49_code 
group by ac.year,mce.intermediate_region_name  
...
group by ac.year_code, mce.intermediate_region_name
having ac.year_code between 2011 and 2020 or ac.year_code between 20110000 and 20200000
