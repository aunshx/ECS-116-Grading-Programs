...
from m49_codes_expanded m, africa_fs_after_cleaning_db a 
where m.region_name = 'Africa'
and m.intermediate_region_code = '' and m.m49_code = a.area_code_m49 
order by a.area;
...
from africa_fs_after_cleaning_db a, m49_codes_expanded m
where m.sub_region_code !='' and m.m49_code = a.area_code_m49 and item_code = '22013'
...
-- for each intermeidate region in AFrica and not including countries where intermediate 
-- region is empty
...
from m49_codes_expanded m, africa_fs_after_cleaning_db a
where m.intermediate_region_code != '' and m.m49_code = a.area_code_m49 and item_code = '22013'
